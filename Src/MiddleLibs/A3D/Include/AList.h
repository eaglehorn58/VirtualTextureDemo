...
public:		//	Operations
	...
	void AddListToTail(const AList<T, ARG_T>& list);
...
AList<T, ARG_T>::AList(int iPoolSize/* 10 */)
{
	m_pHead		= NULL;
	m_pTail		= NULL;
	m_pFree		= NULL;
...
//	Allocate a new node
template <class T, class ARG_T>
typename AList<T, ARG_T>::s_NODE* AList<T, ARG_T>::AllocNode()
{
	if (!m_pFree)
	{
...
//	Free a node
template <class T, class ARG_T>
void AList<T, ARG_T>::FreeNode(s_NODE* pNode)
{
	ASSERT(pNode);
...
//	Get head position of list
template <class T, class ARG_T>
ALISTPOSITION AList<T, ARG_T>::GetHeadPosition() const
{
...
//	Get tail position of list
template <class T, class ARG_T>
ALISTPOSITION AList<T, ARG_T>::GetTailPosition() const
{
...
//	Add a item to head of list
template <class T, class ARG_T>
ALISTPOSITION AList<T, ARG_T>::AddHead(ARG_T Data)
{
...
//	Add a item to tail of list
template <class T, class ARG_T>
ALISTPOSITION AList<T, ARG_T>::AddTail(ARG_T Data)
{
	s_NODE* pNode = AllocNode();
...
//	Link another list to tail of this one
template <class T, class ARG_T>
void AList<T, ARG_T>::AddListToTail(const AList<T, ARG_T>& list)
{
	ALISTPOSITION pos = list.GetHeadPosition();
	while (pos)
...
//	Insert a item after specified position
template <class T, class ARG_T>
ALISTPOSITION AList<T, ARG_T>::InsertAfter(ALISTPOSITION Pos, ARG_T Data)
{
	if (!Pos)
		return AddTail(Data);
...
//	Insert a item before specified position
template <class T, class ARG_T>
ALISTPOSITION AList<T, ARG_T>::InsertBefore(ALISTPOSITION Pos, ARG_T Data)
{
	if (!Pos)
		return AddHead(Data);
...
//	Search a item in list
template <class T, class ARG_T>
ALISTPOSITION AList<T, ARG_T>::Find(ARG_T Data, ALISTPOSITION StartPos/* NULL */) const
{
...
//	Search a item with speicified index
template <class T, class ARG_T>
ALISTPOSITION AList<T, ARG_T>::FindByIndex(int iIndex) const
{
...
//	Remove item at specified position
template <class T, class ARG_T>
T AList<T, ARG_T>::RemoveAt(ALISTPOSITION Pos)
{
	ASSERT(Pos);
...
//	Set item
template <class T, class ARG_T>
void AList<T, ARG_T>::SetByIndex(int iIndex, ARG_T Data)
{
...
template <class T, class ARG_T>
void AList<T, ARG_T>::SetAt(ALISTPOSITION Pos, ARG_T Data)
{
	ASSERT(Pos);
...
//	Get item
template <class T, class ARG_T>
const T& AList<T, ARG_T>::GetByIndex(int iIndex) const
{
	return ((s_NODE*)FindByIndex(iIndex))->Data;
}

template <class T, class ARG_T>
T& AList<T, ARG_T>::GetByIndex(int iIndex)
{
	return ((s_NODE*)FindByIndex(iIndex))->Data;
}

template <class T, class ARG_T>
const T& AList<T, ARG_T>::GetAt(ALISTPOSITION Pos) const
{
	ASSERT(Pos);
...
template <class T, class ARG_T>
T& AList<T, ARG_T>::GetAt(ALISTPOSITION Pos)
{
	ASSERT(Pos);
	return ((s_NODE*)Pos)->Data;
}
...
//	Get previous item
template <class T, class ARG_T>
const T& AList<T, ARG_T>::GetPrev(ALISTPOSITION& Pos) const
{
	ASSERT(Pos);
...
template <class T, class ARG_T>
T& AList<T, ARG_T>::GetPrev(ALISTPOSITION& Pos)
{
	ASSERT(Pos);
	T& Ret	= ((s_NODE*)Pos)->Data;
	Pos		= (ALISTPOSITION)((s_NODE*)Pos)->pPrev;
...
//	Get next item
template <class T, class ARG_T>
const T& AList<T, ARG_T>::GetNext(ALISTPOSITION& Pos) const
{
	ASSERT(Pos);
	T& Ret	= ((s_NODE*)Pos)->Data;
...
template <class T, class ARG_T>
T& AList<T, ARG_T>::GetNext(ALISTPOSITION& Pos)
{
	ASSERT(Pos);
	T& Ret	= ((s_NODE*)Pos)->Data;
	Pos		= (ALISTPOSITION)((s_NODE*)Pos)->pNext;
...
//	Get the first item
template <class T, class ARG_T>
const T& AList<T, ARG_T>::GetHead() const
{
	ASSERT(m_pHead);
	return m_pHead->Data;
}
...
//	Get the last item
template <class T, class ARG_T>
const T& AList<T, ARG_T>::GetTail() const
{
	ASSERT(m_pTail);
	return m_pTail->Data;
}
...
public:		//	Operations
	...
	//	Link another list to tail of this one
	void AddListToTail(const APtrList& list);
	//	Insert a item after specified position
...
//	Link another list to tail of this one
template <class T>
void APtrList<T>::AddListToTail(const APtrList& list)
{
	m_PointerList.AddListToTail(list.m_PointerList);
}
